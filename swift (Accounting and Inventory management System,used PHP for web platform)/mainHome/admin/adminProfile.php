...
<body>
    ...
    <section id="container" class="">
        ...
        <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><img alt="avatar" src="./img/Swift-2.png"> <span class="lite"></span></a>
            <!--logo end-->
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <img src="./img/12.png" width="180" height="215"><br>

                        <img src="./img/13.png" width="180" height="215">
                    </li>
                        ...
                        <div class="profile-widget profile-widget-info">
                            <div class="panel-body">
                                ...
                                <div class="col-lg-4 col-sm-4 follow-info">
                                    <p>Hello I’m <?php echo $name;?>, a leading expert in interactive and creative design.</p>
                                    <p>@jenifersmith</p>
                                    ...
                                    <div id="profile" class="tab-pane active">
                                        <section class="panel">
                                            <div class="bio-graph-heading">
                                                I'm <?php echo $name;?>, a leading expert in interactive and creative design specializing in the mobile medium. My graduation from Massey University with a Bachelor of Design majoring in visual communication.
                                            </div>
                                            ...
                                            <div class="panel-body bio-graph-info">
                                                ...
                                                <form class="form-horizontal" role="form">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" name="f-name" placeholder=" ">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-lg-2 control-label">Last Name</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" name="l-name" placeholder=" ">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" name="b-day" placeholder=" ">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
