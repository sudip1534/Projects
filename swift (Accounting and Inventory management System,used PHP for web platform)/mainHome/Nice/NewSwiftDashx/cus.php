...
<body>
    ...
    <section id="container" class="">
        ...
        <header class="header">
            ...
            <!-- <form> <input style="width: 100px; padding: 10px; cursor: pointer; box-shadow: 6px 6px 5px; #999; -webkit-box-shadow: 6px 6px 5px #999; -moz-box-shadow: 6px 6px 5px #999; font-weight: bold; background:blue; color: #000; border-radius: 10px; border: 1px solid #999; font-size: 150%;" type="button" value="LogOut" onclick="window.location.href='http://localhost/SwiftPage/Nice/login.php'" />
                  </form>          
                -->
            ...
            <!-- http://localhost/SwiftPage/Nice/login_customer.php  -->
        ...
        <span class="icon-bar"></span>
                ...
                <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <?php echo '<a href="customerinfo.php">CustomerInfo</a>.'; ?></li>



                        <li>
                            <?php echo '<a href="invoice.php">Invoice</a>.'; ?></li>
                        ...
                        <li>
                            <?php echo '<a href="payment.php">Payment</a>.'; ?></li>

                        <li>
                            <?php echo '<a href="order.php">Order</a>.'; ?></li>
