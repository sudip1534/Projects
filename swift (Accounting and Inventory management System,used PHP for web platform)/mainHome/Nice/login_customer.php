<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT Customer_id FROM Customer_info WHERE Customer_id = '$myusername' and password = '$mypassword'";
      ...
      if($count == 1) {
		...
		header("location: NewSwiftDashx/customerinfo.php");
...
<a href="http://www.w3.org/">  <img src="img/sw.png" alt="Center" style="width:157.394px;height:192.525px;"> </a>
        ...
        <div>&nbsp</div>
        <div>&nbsp</div>
      <form class="login-form"  method="post" action="login_customer.php" >        
