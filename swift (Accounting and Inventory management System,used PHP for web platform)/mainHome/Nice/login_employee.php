<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT Employee_id,Company_ID FROM login WHERE Employee_id = '$myusername' and Company_ID= '$myusername' and Passward = '$mypassword'";
      ...
      if($count == 1) {
		...
		$_SESSION['myusername']=$myusername;
         header("location: NewSwiftDashx/employeeinfo.php");
...
<a href="http://www.w3.org/">  <img src="img/sw.png" alt="Center" style="width:157.394px;height:192.525px;"> </a>
        ...
        <div>&nbsp</div>
        <div>&nbsp</div>
      <form class="login-form"  method="post" action="login_employee.php">        
        ...
        <div class="login-wrap">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control"  value="" name = "username" autofocus>
            </div>
            <div class="input-group">
