            ...
            <div class="container">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th style="color: black">Company ID</th>
                    ...
                    $query = "select *
                                    from order_status
                                    inner join orders on order_status.Order_id = orders.Order_id
                    ...
                    while ($result->num_rows==1){
                        $res = $result->fetch_assoc();
                        $invoiceId = $res["Invoice_No"];
                        $employeeId = $res["Employee_id"];
                        $companyId=$res["Company_ID"];
                        $status=$res["Status"];
                        $salesStatus=$res["Sales_Status"];
                        $date=$res["Date"];
                        ?>
                        <tr>
                    ...
                    <!-- write query to retrive those data-->
                    <?php
                    ...
                    //                    $query ="";
                    //                    $result = $conn->query($query);
                    //                    $res = $row["quantity"] * $row["product_price"];
                    //                    $resNum = 0;
                    //
