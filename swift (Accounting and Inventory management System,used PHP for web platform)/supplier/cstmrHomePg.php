            ...
            <div class="arrivals-grids">
                <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                    <div class="grid-arr">
                        ...
                        <div class="women">
                            <h6><a href="single.html">productName</a></h6>          <?php //Query  product name, price , description?>
                ...
                <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                    <div class="grid-arr">
                        ...
                        <div class="women">
                            <h6><a href="single.html">productName</a></h6>
                            <span class="size">XL / XXL / S </span>
                            <p ><em class="item_price">70.00 BDT</em></p>
                            <a href="#" data-text="Add To Cart" class=" my-cart-b item_add">Add To Cart</a>
                        </div>
                    </div>
                </div>
...
<!--echo "<li><a href=\"trimesterStu.php? trimester=$row[semester] &amp; yr=$row[year]\">-->
<!--        $row[semester] - $row[year]</a></li>";-->
